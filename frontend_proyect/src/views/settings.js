...
export function mostrarConfiguracion(stateData) {
  ...
  const urlApi = localStorage.getItem('finance_api_url') || 'http://localhost:8001/api/v1';
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div class="p-6 rounded-2xl glass-panel space-y-4">
            ...
            <p class="text-[11px] text-slate-500 leading-normal">
              Cambia entre el modo claro y el modo oscuro para adaptar la aplicación a tus preferencias visuales.
            </p>
            <button onclick="window.alternarTema()" class="btn-secondary w-full text-xs py-2 flex items-center justify-center gap-2 font-semibold">
          ...
          <div class="p-6 rounded-2xl glass-panel border border-violet-100 dark:border-violet-950/60 space-y-4">
            ...
            <form onsubmit="guardarIntegracionBackend(event)" class="space-y-4">
              ...
              <div>
                ...
                <input type="text" id="api-url" class="form-input-custom text-xs py-2" placeholder="http://localhost:8001/api/v1" value="${urlApi}">
              </div>
